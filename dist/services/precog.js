...
class Precog {
    ...
    train() {
        ...
        const net = new recurrent_js_1.RNN(netOpts);
        // instantiate a graph with backprop-ability
        const graph = new recurrent_js_1.Graph(true);
        let decision = undefined, previousDecision = undefined;
        for (let i = 0, end = test.length; i < end; i++) {
            ...
            */
            ...
            const state = new recurrent_js_1.Mat(3, 1);
